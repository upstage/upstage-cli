...
var related = require('helper-related')({linkify: toLink, configProp: 'verbiage'});
var links = 'related.links';

module.exports = function (cwd, base, pkg) {
  var relatedLinks = get(pkg, ['verbiage', links].join('.')) || get(pkg, 'dependencies') || get(pkg, 'devDependencies');
